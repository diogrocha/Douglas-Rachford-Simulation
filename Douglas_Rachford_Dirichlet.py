...
fstream=open('/Users/diogorocha/Documents/MCE/Projeto/centrevalues/centre2.txt','a')
centre=np.zeros(100)
...
# Rotation of the tridimensional matrix
    ...
    ##
        ...
        pl.ylabel('Y')
        pl.colorbar()
        fname='/Users/diogorocha/Desktop/relatório/Discreti/DOUGLASRACHFORDIMAGE%04d.png'%(t+1)
        pl.savefig(fname)
        iteo += 1
